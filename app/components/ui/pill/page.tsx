    ...
    <div className='flex gap-4 h-full tc w-full'>
        <div className='w-full md:w-[70%] overflow-y-scroll scrollbar-hide pb-10 h-screen'>
            <div  ref={pageRefs[0]} id="level1" className='flex gap-4 flex-col mt-20 py-4'>
                <h1 className='text-3xl font-bold hc'>Pill Menu</h1>
                <p>
                   Animated nav bar with springy pill trnasition
                </p>
                <ComponentContainer 
                     ...
                     <table className='w-full mt-2'>
                        ...
                        <tbody>
                            <tr className='border-t-1 bc'>
                              ...
                              <td>string</td>
                              <td>none</td>
                              <td>p-1 rounded-full w-fit bg-white <br/>border-2 border-black flex</td>
                            </tr>
                            <tr className='border-t-1 bc'>
                            ...
                            <tr className='border-t-1 bc'>
                              <td className='p-2'>listStyle</td>
                              <td>string</td>
                              <td>none</td>
                              <td>p-2 px-4 text-xs md:text-[16px] <br/>rounded-full cursor-pointer</td>
                            </tr>
                            <tr className='border-t-1 bc'>
                              <td className='p-2'>pillStyle</td>
                              <td>string</td>
                              <td>none</td>
                              <td>rounded-full bg-black</td>
                            </tr>
                        </tbody>
