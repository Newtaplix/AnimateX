...
const Choose = () => {
  ...
  return (
    <motion.div layout className="py-8 md:py-0">
        ...
        <motion.div layout>
                <motion.div layout className='border-2 rounded-md p-2 w-80 border-gray-300 flex-wrap gap-2 flex relative'>
                   
                    {
                        choosenSkillList.length === 0 ?
                       
                        <motion.span className='text-xs text-gray-400'>No skill selected</motion.span> :
