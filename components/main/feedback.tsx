    ...
    <>
      <AnimatePresence>
        {!isOpen && (
          ...
          >
            <motion.div layoutId="icon" className="text-white">
              <MessageCircleIcon />
            </motion.div>
          </motion.div>
        )}
          ...
          >
            <div className="p-2 flex justify-between w-full py-3 mb-4 items-center">
              ...
              <motion.div
                ...
                className="bg-gray-300/20 p-2 cursor-pointer rounded-full w-8 h-8 flex items-center justify-center"
              >
                <X />
              </motion.div>
            </div>
            {isOpen && (
              ...
              >
                <input
                  type="text"
                  className="border-2 border-gray-300/20 p-2 rounded-md outline-gray-400"
                ...
                <textarea
                  ...
                  placeholder="Message"
                  id=""
                  className="h-20 border-2 border-gray-300/40 rounded-md outline-gray-400 p-2"
                ></textarea>
                <button className="w-full py-2 text-center dark:bg-black text-black bg-white rounded-md">
                  Send
                </button>
              </motion.div>
            )}
