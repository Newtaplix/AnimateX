  ...
  return (
   <>
    ...
    <div>
        ...
        <div className='flex p-2 w-full py-1 md:py-2 md:px-4 relative border border-gray-300 rounded-full'>
            {
                ...
                className='text-black bg-transparent cursor-pointer text-xs md:text-[16px] z-10 font-bold flex items-center flex-1 justify-center text-center relative px-2 md:px-4 py-1 rounded-full'>
                <motion.span 
                animate={{
